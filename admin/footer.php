...
<body>
    ...
    <ul class="footer-info">
        ...
        <br> 
        <li><i class="fas fa-map-marker-alt icon"></i>203 Fake St. Mountain View, San Francisco, California, USA</li>
        <li><i class="fas fa-phone icon"></i><a href="tel:+23923929210">+2 392 3929 210</a></li>
        <li><i class="fas fa-envelope icon"></i><a href="mailto:info@yourdomain.com">info@yourdomain.com</a></li>
    </ul>
</div>
